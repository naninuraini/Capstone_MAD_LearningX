...
class TahunanTransaksi extends GetView<HomeController> {
  final MyUser? myUser;
  const TahunanTransaksi({super.key, required this.myUser});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(() {
      ...
      if (controller.yearlyTransactions.isEmpty) {
        return Column(
          children: [
      ...
      return Padding(
        ...
        child: ListView.builder(
          itemCount: controller.yearlyTransactions.length,
          shrinkWrap: true,
          itemBuilder: (context, index) {
            final post = controller.yearlyTransactions[index];
            return Padding(
